...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Inbox',
            fields=[
                ('author', models.ForeignKey(default=uuid.uuid4, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='Author.author')),
                ('type', models.CharField(default='inbox', editable=False, max_length=30)),
                ('items', models.ManyToManyField(default=list, to='Posts.Post')),
            ],
        ),
    ]
